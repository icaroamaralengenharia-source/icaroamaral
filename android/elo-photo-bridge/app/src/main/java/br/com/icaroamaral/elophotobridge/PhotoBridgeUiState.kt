...
enum class PhotoBridgeFlowStatus {
  ...
  AI_CONFIRMATION,
  FAST_TIMELINE,
  FAST_TIMELINE_PREVIEW,
  FAST_TIMELINE_READY_FOR_ACTION,
  CLASSIFYING_PHOTOS,
...
data class PhotoBridgeUiState(
  ...
  val fastTimelineSessionJson: String = "",
  val fastTimelineSessionId: String = "",
  val fastTimelineCurrentStage: String = "",
  val fastTimelineSelectedPhotoIndex: Int = -1,
  val fastTimelineStatus: String = "",
  val fastTimelineCategoryMarkersJson: String = "",
