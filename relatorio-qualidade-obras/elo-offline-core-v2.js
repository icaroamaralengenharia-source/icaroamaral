(function (root) {
  ...
  var rules = [
    ...
    ["music_next", ["próxima música", "proxima musica", "pular música", "pular musica", "outra música", "outra musica"], "A próxima faixa depende da fila local disponível."],
