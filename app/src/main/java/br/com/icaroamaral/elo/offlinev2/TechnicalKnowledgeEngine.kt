...
class TechnicalKnowledgeEngine(private val entries: List<TechnicalEntry>) {
    ...
    companion object {
        ...
        fun defaults(): TechnicalKnowledgeEngine = TechnicalKnowledgeEngine(listOf(
            ...
            TechnicalEntry("revestimentos", listOf("revestimento", "fissura", "reboco"), "Fissuras em revestimentos podem resultar de retração, base sem preparo, espessura excessiva, movimentação da estrutura, cura inadequada ou incompatibilidade entre camadas."),
            TechnicalEntry("chapisco", listOf("chapisco"), "Chapisco é a camada de preparo aplicada sobre a base para aumentar a aderência do revestimento. A superfície deve estar limpa, firme e receber a execução e a cura previstas para o sistema."),
